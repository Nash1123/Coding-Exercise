 ...
 * <li><code>plotter</code> package will only work with the javabuilder.jar file included with MCR version 8.1.</li>
 * </ul>
 * </p> 
 ...
 * of <code>plotter</code> package, can take instances of these concrete classes as 
