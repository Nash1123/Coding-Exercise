 ...
 * <li><code>convolution</code> package will only work with the javabuilder.jar file included with MCR version 8.1.</li>
 * </ul>
 * </p> 
 ...
 * of <code>convolution</code> package, can take instances of these concrete classes as 
